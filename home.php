...
<head>
    ...
    <title>QR Landing Page HTML Template</title>
<!--
            ...
            <div class="container">
                <div class="row">
                    <div class="left-text col-lg-6 col-md-12 col-sm-12 col-xs-12"
                        ...
                        <h1>QR Scan Attendance Management<em>Project</em></h1>
                        <p>QR <a href="#"> -- </a> This is a home page <a href="#">TemplateMo</a>.
            ...
            <div class="row">
                <div class="col-lg-12">
                    <div class="sub-footer">
                        <p>Copyright &copy; 2020 QR Landing Page

                        | Designed by Abdul and Team</a></p>
                    </div>
                </div>
            </div>
        </div>
